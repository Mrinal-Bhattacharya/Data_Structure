package com.interviewbit.graph.depthfirstsearch;
...
public class LargestDistanceBetweenNodesOfATree {
    ...
    private int dfs(final ArrayList<ArrayList<Integer>> graph, final int n, int u) {
        int max = 0;
    ...
    private int bfs(final ArrayList<ArrayList<Integer>> graph, final int n, int node) {
        boolean[] vis = new boolean[n];
